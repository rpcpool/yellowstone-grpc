...
func (x *Transaction) GetMessageHash() string {
	if x != nil {
...
const file_solana_storage_proto_rawDesc = "" +
	...
	"\x04meta\x18\x02 \x01(\v24.solana.storage.ConfirmedBlock.TransactionStatusMetaR\x04meta\"\x92\x01\n" +
	"\vTransaction\x12\x1e\n" +
	"\n" +
	"signatures\x18\x01 \x03(\fR\n" +
	"signatures\x12@\n" +
	"\amessage\x18\x02 \x01(\v2&.solana.storage.ConfirmedBlock.MessageR\amessage\x12!\n" +
	"\fmessage_hash\x18\x03 \x01(\tR\vmessageHash\"\x81\x03\n" +
	"\aMessage\x12D\n" +
