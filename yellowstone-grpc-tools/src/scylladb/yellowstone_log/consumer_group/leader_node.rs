use {
    crate::scylladb::{
        etcd_utils::lease::ManagedLease,
        types::{BlockchainEventType, ConsumerGroupId, InstanceId, ProducerId},
        yellowstone_log::{
            common::InitialOffset, consumer_group::etcd_path::get_producer_lock_path_v1,
        },
    },
    etcd_client::{WatchOptions, Watcher},
    futures::Future,
