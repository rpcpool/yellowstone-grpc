...
- plugin: gossip contact info stores the startup replay complete flag even with no subscriber waiting, so `contact info startup replay complete` is logged once instead of on every update.
