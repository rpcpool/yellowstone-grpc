    ...
    fn update_account(
        ...
        self.with_inner(|inner| {
            let account = match account {
                ...
                ReplicaAccountInfoVersions::V0_0_3(info) => (info, slot, is_startup).into(),
                ReplicaAccountInfoVersions::V0_0_4(info) => (info, slot, is_startup).into(),
            };

            let message = Message::Account(account);
            if is_startup {
