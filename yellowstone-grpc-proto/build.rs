fn main() -> anyhow::Result<()> {
    ...
    let geyser_service = tonic_build::manual::Service::builder()
        .name("Geyser")
        .package("geyser")
        .method(
            tonic_build::manual::Method::builder()
                ...
                .output_type("crate::geyser_custom::VecWrap")
        ...
        .build();
    tonic_build::manual::Builder::new().compile(&[geyser_service]);
    ...
    let geyser_rs = geyser_rs.replace(
        "            tonic::Response<tonic::codec::Streaming<crate::geyser_custom::VecWrap>>,",
        "            tonic::Response<tonic::codec::Streaming<crate::geyser::SubscribeUpdate>>,",
    );
